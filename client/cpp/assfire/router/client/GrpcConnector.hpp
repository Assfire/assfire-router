...
namespace assfire::router {
    class GrpcConnector {
      public:
        using RouterServiceStub =
            assfire::api::v1::router::RouterService::StubInterface;
        using ConfigurationServiceStub =
            assfire::api::v1::router::ConfigurationService::StubInterface;
